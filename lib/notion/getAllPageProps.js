...
const getAllPageProps = async (
  ...
  const publishedPageProps = allPageProps.filter(
    (pageProps) => pageProps.status === filters.status
  );
  const sortedPageProps = publishedPageProps.sort((a, b) => {
    sort.publishedAt === "descending"
      ? b.publishedAt - a.publishedAt
      : a.publishedAt - b.publishedAt;
  });
  return sortedPageProps;
};
